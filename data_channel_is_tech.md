...
```
    ...
    ## -1.712 -0.209 -0.107  0.029 72.346 
    ## 
    ## Coefficients:
    ##                              Estimate Std. Error t value Pr(>|t|)    
    ## (Intercept)                 1.071e-15  1.156e-02   0.000 1.000000    
    ## n_tokens_content            8.972e-02  1.731e-02   5.184 2.23e-07 ***
    ## num_hrefs                   7.442e-02  1.555e-02   4.787 1.73e-06 ***
    ## num_self_hrefs             -5.984e-02  1.464e-02  -4.087 4.43e-05 ***
    ## num_imgs                   -2.693e-02  1.420e-02  -1.896 0.057962 .  
    ## num_videos                  2.376e-02  1.170e-02   2.030 0.042353 *  
    ## kw_min_min                  2.019e-02  1.382e-02   1.461 0.144071    
    ## kw_avg_min                 -2.687e-02  1.514e-02  -1.775 0.076004 .  
    ## kw_avg_max                 -4.179e-02  1.547e-02  -2.702 0.006911 ** 
    ## kw_max_avg                 -3.651e-02  2.095e-02  -1.743 0.081460 .  
    ## kw_avg_avg                  9.238e-02  2.018e-02   4.578 4.77e-06 ***
    ## LDA_00                      2.197e-02  1.168e-02   1.881 0.060006 .  
    ## global_rate_positive_words -3.613e-02  1.195e-02  -3.024 0.002503 ** 
    ## avg_negative_polarity      -1.260e-01  2.860e-02  -4.404 1.08e-05 ***
    ## min_negative_polarity       1.112e-01  2.567e-02   4.331 1.51e-05 ***
    ## max_negative_polarity       7.152e-02  1.914e-02   3.736 0.000188 ***
    ## abs_title_subjectivity     -2.178e-02  1.174e-02  -1.856 0.063527 .  
    ## ---
    ## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
    ## 
    ## Residual standard error: 0.9906 on 7329 degrees of freedom
    ## Multiple R-squared:  0.02077,    Adjusted R-squared:  0.01863 
    ## F-statistic: 9.715 on 16 and 7329 DF,  p-value: < 2.2e-16
...
```
    ...
    ## [1] "~"                                                                                                                                                                                                                                                                            
    ## [2] "shares"                                                                                                                                                                                                                                                                       
    ## [3] "n_tokens_content , num_hrefs , num_self_hrefs , num_imgs , num_videos , kw_min_min , kw_avg_min , kw_avg_max , kw_max_avg , kw_avg_avg , LDA_00 , global_rate_positive_words , avg_negative_polarity , min_negative_polarity , max_negative_polarity , abs_title_subjectivity"
...
| TRUE        | TRUE               | FALSE               | FALSE                        | TRUE       | FALSE     | FALSE         | FALSE       | FALSE        | FALSE        | FALSE        | FALSE        | FALSE                        | FALSE                         | FALSE                         | FALSE                 | FALSE                    | FALSE                           |
| TRUE        | TRUE               | FALSE               | FALSE                        | TRUE       | TRUE      | FALSE         | FALSE       | FALSE        | FALSE        | FALSE        | FALSE        | FALSE                        | FALSE                         | FALSE                         | FALSE                 | FALSE                    | FALSE                           |
...
| TRUE        | TRUE               | FALSE               | FALSE                        | TRUE       | TRUE      | FALSE         | FALSE       | TRUE         | FALSE        | FALSE        | TRUE         | FALSE                        | FALSE                         | TRUE                          | FALSE                 | FALSE                    | FALSE                           |
| TRUE        | TRUE               | FALSE               | FALSE                        | TRUE       | TRUE      | FALSE         | FALSE       | TRUE         | FALSE        | TRUE         | TRUE         | FALSE                        | FALSE                         | TRUE                          | FALSE                 | FALSE                    | FALSE                           |
| TRUE        | TRUE               | FALSE               | FALSE                        | TRUE       | TRUE      | FALSE         | TRUE        | TRUE         | FALSE        | TRUE         | TRUE         | FALSE                        | FALSE                         | TRUE                          | FALSE                 | FALSE                    | FALSE                           |
| TRUE        | TRUE               | FALSE               | FALSE                        | TRUE       | TRUE      | FALSE         | TRUE        | TRUE         | FALSE        | TRUE         | TRUE         | FALSE                        | FALSE                         | TRUE                          | FALSE                 | TRUE                     | FALSE                           |
...
| TRUE        | TRUE               | FALSE               | TRUE                         | TRUE       | TRUE      | TRUE          | TRUE        | TRUE         | TRUE         | TRUE         | TRUE         | FALSE                        | TRUE                          | TRUE                          | TRUE                  | TRUE                     | FALSE                           |
...
|:--------|-------------:|-----------------:|------------:|
| lm.fit1 |     8121.643 |        0.0138265 |    2454.322 |
| lm.fit2 |     8638.691 |        0.0118833 |    2714.275 |
| lm.fit3 |     8062.537 |        0.0149108 |    2445.233 |
...
```
    ...
    ##                                        s0
    ## (Intercept)                  2050.4415008
    ## n_tokens_title                  .        
    ## n_tokens_content                0.7693124
    ## n_unique_tokens                 .        
    ## n_non_stop_words                .        
    ## n_non_stop_unique_tokens        .        
    ## num_hrefs                      16.1136312
    ## num_self_hrefs                 -6.4986364
    ## num_imgs                        .        
    ## num_videos                     24.4966604
...
```
    ...
    ##                                        s0
    ## (Intercept)                  1894.8749793
    ## n_tokens_content                0.6413413
    ## n_non_stop_words                .        
    ## n_non_stop_unique_tokens        .        
    ## num_hrefs                      41.0867503
    ## num_imgs                        .        
    ## num_keywords                    .        
    ## num_videos                     45.0603112
    ## kw_avg_max                      .        
    ## kw_min_avg                      .        
    ## kw_max_avg                      .        
    ## kw_avg_avg                      0.1586902
    ## self_reference_min_shares       .        
    ## self_reference_avg_sharess      .        
    ## global_rate_positive_words      .        
    ## rate_positive_words             .        
...
| lm.fit2        |   4984.692 |
| lm.fit3        |   4452.965 |
| lasso.fit.full |   4859.401 |
| lasso.fit.18   |   4389.227 |
| rf.fit1        |   5094.666 |
| rf.fit2        |   4569.608 |
| boostTreefit1  |   4404.877 |
| boostTreefit2  |   4393.291 |
